...
if( $BEGS == "BASE" ) then
   ...
   if($gc_map_method == 1) then
      echo "gc_map $MASDIR/$mas_slc.par $INTDIR/${mas_slv}.off $DEMDIR/${DEM}.par $DEMDIR/$DEM ${mas_slv}.utm.dem.par ${mas_slv}.utm.dem ${mas_slv}.utm_to_rdc 1 1 ${mas_slv}.utm.sim.sar ${mas_slv}.u ${mas_slv}.v ${mas_slv}.linc ${mas_slv}.psi ${mas_slv}.pix - 8 - - >> $PRJDIR/$intLog"
      gc_map $MASDIR/$mas_slc.par $INTDIR/${mas_slv}.off $DEMDIR/${DEM}.par $DEMDIR/$DEM ${mas_slv}.utm.dem.par ${mas_slv}.utm.dem ${mas_slv}.utm_to_rdc 1 1 ${mas_slv}.utm.sim.sar - - - - - - 8 - - >> $PRJDIR/$intLog
      echo $EMP
   else
      echo "gc_map $INTDIR/$mas_slv.pwr1.par - $DEMDIR/${DEM}.par $DEMDIR/$DEM ${mas_slv}.utm.dem.par ${mas_slv}.utm.dem ${mas_slv}.utm_to_rdc 1 1 ${mas_slv}.utm.sim.sar ${mas_slv}.u ${mas_slv}.v ${mas_slv}.linc ${mas_slv}.psi ${mas_slv}.pix - 8 - - >> $PRJDIR/$intLog"
      gc_map $INTDIR/$mas_slv.pwr1.par - $DEMDIR/${DEM}.par $DEMDIR/$DEM ${mas_slv}.utm.dem.par ${mas_slv}.utm.dem ${mas_slv}.utm_to_rdc 1 1 ${mas_slv}.utm.sim.sar - - - - - - 8 - - >> $PRJDIR/$intLog
      echo $EMP
   endif
...
if( $BEGS == "SIM" ) then
   ...
   set np   = `grep interferogram_width: ${mas_slv}.off | awk '{print $2}'`
   echo "rasmph_pwr ${mas_slv}.tflt ${mas_slv}.pwr1 $np 1 1 0 $rasrlks $rasazlks 1. .35  1"
...
if ($BEGS == "DIFF") then
   ...
   echo "rasmph_pwr ${mas_slv}.tflt_sm ${mas_slv}.pwr1 $np 1 1 0 $rasrlks $rasazlks 1. .35  1"
   rasmph_pwr ${mas_slv}.tflt_sm ${mas_slv}.pwr1 $np 1 1 0 $rasrlks $rasazlks 1. .35  1 >> $PRJDIR/$intLog
   echo $EMP
   ...
   if(-e ${mas_slv}.tflt_sm) then
      ...
      echo "rasmph_pwr ${mas_slv}.tflt_sm_utm ${mas_slv}.pwr1_utm $utmw 1 1 0 $rasrlks $rasazlks 1. 0.35 1"
      rasmph_pwr ${mas_slv}.tflt_sm_utm ${mas_slv}.pwr1_utm $utmw 1 1 0 $rasrlks $rasazlks 1. 0.35 1 >> $PRJDIR/$intLog
      echo $EMP
   endif
...
if( $BEGS == "FILT" ) then
   ...
   if ( $brefine == 1 ) then
     ...
     set np   = `grep interferogram_width: $INTDIR/${mas_slv}.off | awk '{print $2}'`
     echo "rasmph_pwr ${mas_slv}.tflt_sm_rmp ${mas_slv}.pwr1 $np 1 1 0 $rasrlks $rasazlks 1. .35  1"
     rasmph_pwr ${mas_slv}.tflt_sm_rmp ${mas_slv}.pwr1 $np 1 1 0 $rasrlks $rasazlks 1. .35  1 >> $PRJDIR/$intLog
     echo $EMP
   endif
   ...
   if(-e ${mas_slv}.tflt_sm_rmp) then
      ...
      echo $EMP
      #raster geocoded filtered interferogram
      echo "rasmph_pwr ${mas_slv}.tflt_sm_rmp_utm ${mas_slv}.pwr1_utm $utmw 1 1 0 $rasrlks $rasazlks 1. 0.35 1"
      rasmph_pwr ${mas_slv}.tflt_sm_rmp_utm ${mas_slv}.pwr1_utm $utmw 1 1 0 $rasrlks $rasazlks 1. 0.35 1 >> $PRJDIR/$intLog
      echo $EMP
   endif
